    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-4 pt-6 pb-12 sm:px-6 lg:px-8 space-y-16">
        ...
        <section>
          ...
          <div className="mt-0 text-lg leading-relaxed" style={{ color: '#3A281A' }}>
            <aside className="max-w-lg mx-auto rounded-3xl border border-[rgba(139,105,20,0.3)] p-8 shadow-sm mb-6 text-center" style={{ background: '#FBF6E3' }}>
              <p className="uppercase tracking-widest text-sm font-semibold mb-7" style={{ color: '#8B6914' }}>Picture this</p>
            ...
            <p className="text-xl font-semibold mb-4" style={{ color: '#2D1A00' }}>You know this life.</p>
            ...
            <p style={{ ...headingFont, color: '#2D1A00' }} className="text-2xl font-bold mb-4">
